      ...
      <div className="grid grid-cols-1 mx-auto md:grid-cols-2 md:gap-8">
        {PROBLEMS_LIST.map((problem, index) => (
          <div key={problem.label} className='mb-4 md:mb-0'>
            <div className={`h-[80px] md:h-[100px] justify-center`}>
              <img src={problem.icon} alt={problem.label} width={100} height={100} className={`w-[${problem.sWidth}px] md:w-[${problem.width}px]  mx-auto`}/>
            </div>
